...
function loadSkills12() {
  var ctx = document.getElementById('skill12').getContext('2d');
  var al = 0;
  var start = 4.72;
  var cw = ctx.canvas.width;
  var ch = ctx.canvas.height;
...
function loadSkills13() {
  var ctx = document.getElementById('skill13').getContext('2d');
  var al = 0;
  var start = 4.72;
  var cw = ctx.canvas.width;
  var ch = ctx.canvas.height;
  ...
  var sim = setInterval(progressSim, 50); //speed
	...
	function loadSkills14() {
  var ctx = document.getElementById('skill14').getContext('2d');
  var al = 0;
  var start = 4.72;
  var cw = ctx.canvas.width;
  var ch = ctx.canvas.height;
...
function loadSkills15() {
  var ctx = document.getElementById('skill15').getContext('2d');
  var al = 0;
  var start = 4.72;
  var cw = ctx.canvas.width;
  var ch = ctx.canvas.height;
